...
<l>Đáp ứng nhanh theo sự thay đổi của hệ thống mạng</l>
<l>Gửi cập nhật khi hệ thống mạng có sự thay đổi</l>
<l>Gửi cập nhật định kỳ để kiểm tra trạng thái đường liên kết</l>
<l>Sử dụng cơ chế hello để xác định router láng giềng có còn kết nối được hay không</l>
